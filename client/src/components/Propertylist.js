...
const Propertylist = () => {
  ...
  const handleLike = (propertyId) => {
    if (likedProperties.includes(propertyId)) {
      ...
      const confirmation = window.confirm("Are you sure you want to remove this property from liked?");
      if (confirmation) {
        ...
        <div className="popup-container">
          <div className="popup-body">
            <div className="popup-header">
              ...
              <div>
                <ImageSlider slides={selectedProperty.sliderImages} handleLike={handleLike} selectedProperty={selectedProperty} />
              </div>
